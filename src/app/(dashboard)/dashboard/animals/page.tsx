...
export default function AnimalsPage() {
  ...
  return (
    <div className="max-w-5xl">
      ...
      {showForm && (
        <div
          className="fixed inset-0 z-50 flex items-start justify-center bg-black/30 backdrop-blur-sm px-4 pt-10 pb-10 overflow-y-auto"
          onClick={() => {
            setShowForm(false);
            setEditingId(null);
          }}
        >
          <form
            ...
            className="bg-white rounded-2xl p-6 w-full max-w-xl shadow-xl space-y-4"
          >
            <div className="flex items-center justify-between mb-2">
              <h2 className="text-lg font-semibold">
                {editingId ? "Редагувати" : "Додати тварину"}
              </h2>
              <button
                type="button"
                onClick={() => {
